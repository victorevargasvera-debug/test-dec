...
{
  private SplashWindowStates state = SplashWindowStates.WAIT_FOR_ACTIVATE;
  ...
  public SplashScreen(TimeSpan min, TimeSpan max, int radius, string productVersionText)
  {
    ...
    if (productVersionText != null && productVersionText.Length > 0)
  ...
  private void timer1_Tick(object sender, EventArgs e)
  {
    ...
    if (this.state == SplashWindowStates.SHOWN)
    {
      ...
      if (!this.CheckCloseWindowRequest())
      {
        ...
        try
        {
          if (this._Min > TimeSpan.Zero && this._Max > this._Min)
  ...
  protected override void OnActivated(EventArgs e)
  {
    ...
    else if (this.state != SplashWindowStates.CLOSED)
      ;
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.label2.Text = "© 2016 MOTOROLA SOLUTIONS, INC.  PROTECTED BY U.S. AND INTERNATIONAL COPYRIGHT LAWS";
