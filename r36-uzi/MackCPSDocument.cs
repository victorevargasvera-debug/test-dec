...
public class MackCPSDocument : AcpDocument
{
  ...
  protected override void AddNewFeatures(string codeplugVersion)
  {
    ...
    else
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature1)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.FactoryOverrides.FactoryOverrides)
        {
          ...
          if (parent[10905] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new RxFrequency(parent));
        }
      }
    }
    ...
    else
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature9)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.RadioWide.RadioWide)
        {
          ...
          if (parent[10819] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new Sensor(parent));
          if (parent[10908] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new MultiCodeplug(parent));
          if (parent[10907] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new Accessory(parent));
        }
      }
    }
    ...
    else
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature10)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.DataWide.DataWide)
        {
          ...
          if (parent[10849] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new ExternalDataModem(parent));
          if (parent[10910] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new BookmarkQuickAccess(parent));
          if (parent[10912] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new WebBrowser(parent));
        }
      }
    }
    ...
    IAcpRecordset feature13 = this.GetFeature(2055);
    if (feature13 != null)
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) (feature13 as Recordset))
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.SecureKMFProfile.SecureKMFProfile)
        {
          IAcpFeatureSection section = parent[10881];
          if (section == null)
          {
            section = (IAcpFeatureSection) new SecureHardwareEncryptionIndependentKeyList(parent);
            parent.AddFeatureSection(section);
          }
          if (section.EmbeddedRecset == null)
            section.EmbeddedRecset = (IAcpRecordset) new SecureHardwareEncryptionIndependentKeyListInnerRecset();
          if (parent[10883] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new Motorola.MackinawCPS.CoreFeatures.SecureKMFProfile.General(parent));
        }
      }
    }
    IAcpRecordset feature14 = this.GetFeature(2059);
    if (feature14 == null)
    {
    ...
    IAcpRecordset feature15 = this.GetFeature(2064);
    if (feature15 == null)
    {
    ...
    else
    {
      ...
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.TrunkingSystem.TrunkingSystem && parent[10889] == null)
          parent.AddFeatureSection((IAcpFeatureSection) new Broadband(parent));
      }
    }
    ...
    IAcpRecordset feature16 = this.GetFeature(2051);
    if (feature16 == null)
    {
    ...
    IAcpRecordset feature17 = this.GetFeature(2032);
    if (feature17 == null)
    {
    ...
    else
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature17)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.EmergencyWide.EmergencyWide)
        {
          ...
          if (parent[10854] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new EmergencyWideImpactDetection(parent));
        }
      }
    }
    IAcpRecordset feature18 = this.GetFeature(2075);
    if (feature18 == null)
    {
    ...
    else
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature18)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.ConventionalEmergencyProfiles.ConventionalEmergencyProfiles)
        {
          ...
          if (parent[10846] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new EmergencyCompatibilityOptionsConventional(parent));
        }
      }
    }
    IAcpRecordset feature19 = this.GetFeature(2076);
    if (feature19 == null)
    {
    ...
    else
    {
      ...
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.TrunkingEmergencyProfiles.TrunkingEmergencyProfiles)
        {
          if (parent[10775] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new TrunkingEmergencyToneList(parent));
          if (parent[10845] == null)
            parent.AddFeatureSection((IAcpFeatureSection) new EmergencyCompatibilityOptionsTrunking(parent));
        }
      }
    }
    IAcpRecordset feature20 = this.GetFeature(2045);
    if (feature20 == null)
    {
      FeatureManager.AddFeature((IAcpRecordset) new RadioWideRecset());
    }
    ...
    IAcpRecordset feature21 = this.GetFeature(2042);
    if (feature21 == null)
    {
      FeatureManager.AddFeature((IAcpRecordset) new ButtonsRecset());
    }
    ...
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature21)
      {
    ...
    IAcpRecordset feature22 = this.GetFeature(2125);
    if (feature22 == null)
    {
      FeatureManager.AddFeature((IAcpRecordset) new RadioVIPsRecset());
    }
    ...
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature22)
      {
    ...
    IAcpRecordset feature23 = this.GetFeature(2033);
    if (feature23 == null)
    {
      FeatureManager.AddFeature((IAcpRecordset) new RadioErgonomicsWideRecset());
    }
    ...
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature23)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.RadioErgonomicsWide.RadioErgonomicsWide && parent[10818] == null)
          parent.AddFeatureSection((IAcpFeatureSection) new LogicalProfileConfiguration(parent));
      }
    }
    IAcpRecordset feature24 = this.GetFeature(2033);
    if (feature24 == null)
    {
      FeatureManager.AddFeature((IAcpRecordset) new RadioErgonomicsWideRecset());
    }
    ...
    {
      foreach (FeatureNode parent in (Collection<FeatureNode>) feature24)
      {
        if (parent is Motorola.MackinawCPS.CoreFeatures.RadioErgonomicsWide.RadioErgonomicsWide && parent[10909] == null)
          parent.AddFeatureSection((IAcpFeatureSection) new ApplicationSessionLock(parent));
      }
    }
    if (this.GetFeature(4237) != null)
      return;
