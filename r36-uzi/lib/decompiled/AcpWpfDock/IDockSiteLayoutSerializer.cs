...
// Type: DevComponents.WpfDock.IDockSiteLayoutSerializer
...
public interface IDockSiteLayoutSerializer
{
  string SaveLayout(DockSite ds);

  void LoadLayout(DockSite ds, string layout);
}
