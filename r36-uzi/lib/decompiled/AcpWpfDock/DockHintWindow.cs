...
// Type: DevComponents.WpfDock.DockHintWindow
...
internal class DockHintWindow : EmptyWindow
{
  static DockHintWindow()
  {
    FrameworkElement.DefaultStyleKeyProperty.OverrideMetadata(typeof (DockHintWindow), (PropertyMetadata) new FrameworkPropertyMetadata((object) typeof (DockHintWindow)));
  }
