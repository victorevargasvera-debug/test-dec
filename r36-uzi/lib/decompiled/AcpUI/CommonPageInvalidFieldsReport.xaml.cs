...
// Type: AcpUI.Common.PageInvalidFieldsReport
...
public partial class PageInvalidFieldsReport : Page, IComponentConnector
{
  ...
  internal GridViewColumn FieldsReportGVC5;
  private bool _contentLoaded;

  public PageInvalidFieldsReport() => this.InitializeComponent();
  ...
  public void InitializeComponent()
  {
    ...
    Application.LoadComponent((object) this, new Uri("/AcpUI;component/common/pageinvalidfieldsreport.xaml", UriKind.Relative));
  }
  ...
  void IComponentConnector.Connect(int connectionId, object target)
  {
    switch (connectionId)
    {
      ...
      case 6:
        ...
        break;
      case 7:
        this.FieldsReportGVC5 = (GridViewColumn) target;
        break;
      default:
        this._contentLoaded = true;
        break;
